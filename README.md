...
http://localhost:3000/appmodern  
http://localhost:3000/appclassic  
http://localhost:3000/appminimal  
http://localhost:3000/saas  
http://localhost:3000/saasmodern  
http://localhost:3000/saasclassic  
http://localhost:3000/saasminimal  
http://localhost:3000/saasminimal2  
http://localhost:3000/hosting  
http://localhost:3000/hostingmodern  
http://localhost:3000/portfolio  
http://localhost:3000/ride  
http://localhost:3000/crypto  
http://localhost:3000/cryptomodern  
http://localhost:3000/charity  
http://localhost:3000/interior  
http://localhost:3000/agency  
http://localhost:3000/agencymodern  
http://localhost:3000/agencydigital  
http://localhost:3000/saascreative  
http://localhost:3000/fooddelivery  
http://localhost:3000/saasappdark  
http://localhost:3000/appcreative2  
http://localhost:3000/webapp  
http://localhost:3000/webappminimal  
http://localhost:3000/webappcreative  
